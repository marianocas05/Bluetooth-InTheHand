...
namespace TestDrive
{
    ...
    {
        public float Frequency { get; set; } //Frequência central (ex.: 100 Hz, 1 kHz)
        public float Bandwidth { get; set; } //Largura de banda (ex.: 0.8f para bandas médias)
        public float Gain { get; set; } //Ganho em dB (ex.: -12 a +12)
    }
